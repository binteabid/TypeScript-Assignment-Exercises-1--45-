...
let worldTour: string[] = ["Makkah", "Madina", "Karbala", "Istanbul", "Mount Everest"];
...
let Languages: string[] = ["Urdu", "English", "Arabic", "Turkish", "Persian"];
...
let allCandidatesData: { [key: string]: any } = {
    "candidate1": {
        name: "Hamza",
        rollNumber: 40,
