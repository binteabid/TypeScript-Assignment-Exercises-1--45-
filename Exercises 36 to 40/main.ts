...
function modifymake_shirt(size: string = 'Large', message: string = 'I love TypeScript'): void {
    console.log(`Making a ${size} t-shirt with the message "${message}" printed on it` );
}
...
// let make_album = (artist: string, title: string, tracks?: number): { artist: string, title: string, tracks?: number } => {
