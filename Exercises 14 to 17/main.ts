...
let guestList:string []=["Sir Shahid Hussain","Sir Shakeel Ansari","Sir Abbas Hussain"]

//Invite each guest for dinner

//Using map method

let inviteGuest:string[]= guestList.map((guest:string)=>`Dear ${guest},it would be an honour for me if yu accept my invitation to dine at our home this weekend. `
...
let guestListof14:string []=["Sir Shahid Hussain","Sir Shakeel Ansari","Sir Abbas Hussain"];

//Changing Array Guest List

let cannotattend :string =guestListof14.splice(1,1)[0];
...
let guestListof15:string []=["Sir Shahid Hussain","Sir Abbas Hussain","Sir Anas"];
...
let guestListof16:string []=[ "Sir Zia","Sir Shahid Hussain","Sir Daniyal","Sir Abbas Hussain","Sir Anas", "Sir Ameen"];
...
let guestListof17:string []=[ "Sir Zia","Sir Shahid Hussain","Sir Daniyal","Sir Abbas Hussain","Sir Anas", "Sir Ameen"];
...
while (guestListof17.length >2){
    ...
    let removedGuests:string | undefined= guestListof17 .pop(); 
