...
const arrayI: number[] = [11, 22, 33, 44, 55];
const itemi: number = 22;
const itemii: number = 50;
...
let favorite_fruits: string[] = ['pineapple', 'strawberry', 'watermelon'];
...
let employeesnames: string[] = ['Admin Sumera', 'Amina', 'Emerald', 'Zeba', 'Admin Zanjabeel'];
