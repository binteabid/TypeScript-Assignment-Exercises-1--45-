...
let usernames: string[] = [];    // it is empty as there is no array in Exercise 28
...
let current_users: string[] = ['Maria', 'Mona', 'Nimra', 'Alice', 'Ember'];

// Array of  New Usernames:

let new_users: string[] = ['alice', 'Mona', 'Zunaira', 'Yusra', 'Huda'];
...
let favPizzas: string[] = ["Chicken Tikka", "Fagitta", "BBQ Chicken"];
...
let exoticPets: string[] = ["Parrot", "Iguana", "Hedgehog"];
